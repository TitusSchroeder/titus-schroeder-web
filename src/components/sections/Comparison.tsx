...
export const Comparison: React.FC = () => {
  const comparisonItems = [
    ...
    },
    {
      ...
      legacyDesc: "Verschachtelte Menüs & Einarbeitung nötigt.",
    ...
    <section id="vergleich" className="py-20 bg-white relative">
      <div className="container mx-auto px-4 sm:px-6 max-w-5xl">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-100 border border-slate-300 text-brand-navy font-bold text-xs uppercase tracking-wider mb-3">
        ...
        {/* Clean, Punchy Comparison Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Legacy Box */}
          <div className="p-7 sm:p-8 rounded-3xl bg-slate-50 border border-slate-300 text-left">
          ...
          <motion.div
            ...
            className="p-7 sm:p-8 rounded-3xl bg-brand-navy text-white border-2 border-brand-blue shadow-xl relative overflow-hidden text-left"
          >
            <div className="flex items-center gap-3 mb-6 pb-4 border-b border-slate-800">
              <div className="w-10 h-10 rounded-xl bg-brand-blue text-white flex items-center justify-center font-bold shrink-0 shadow-glow">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-emerald-400">Schnell & Einfach</p>
              </div>
            </div>
            ...
            <div className="space-y-6">
              {comparisonItems.map((item, idx) => (
                <div key={idx} className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-emerald-400 text-slate-950 flex items-center justify-center shrink-0 mt-0.5 font-bold text-xs shadow-md">
